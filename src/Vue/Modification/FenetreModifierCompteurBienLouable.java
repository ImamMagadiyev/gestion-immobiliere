...
public class FenetreModifierCompteurBienLouable extends JInternalFrame {
    ...
    /**
     * Initialise la fenêtre pour modifier un compteur d'un bien louable,
     * préremplit les champs avec les valeurs actuelles du compteur,
     * et configure les boutons pour valider ou annuler la modification.
     */
    public FenetreModifierCompteurBienLouable(
            Compteur compteur,
            Runnable callback,
            JDesktopPane desktop
    ) {
        super("Modifier compteur " + compteur.getId_compteur(), true, true, true, true);
     ...
     * 
     * Met à jour l'objet Compteur avec les valeurs saisies,
     * enregistre les changements en base via DaoCompteur,
     * puis lance le callback pour rafraîchir l'affichage (tableau) avant de fermer la fenêtre.
     */
